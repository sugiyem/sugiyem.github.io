...
import { Box, Button, Drawer, DrawerOverlay, DrawerBody, DrawerContent, Heading, ListItem, Text, UnorderedList, Stack } from "@chakra-ui/react";
import CustomDrawerHeader from "../components/CustomDrawerHeader";
import Header from "../components/Header";
import Main from "../components/Main";
import { SectionContainer, SectionTitle, SubsectionContainer, SubsectionDate, SubsectionList, SubsectionTitle } from "../styles/GeneralStyles";
...
const Modules: React.FC = () => {
    ...
    function goToSelectedRef(selectedRef: React.MutableRefObject<null | HTMLDivElement>): void {
    ...
    const CustomDrawer: React.FC = () => (
        <Drawer isOpen={isDrawerOpen} placement="right" onClose={closeDrawer}>
            <DrawerOverlay>
                <DrawerContent>
                    <CustomDrawerHeader imageUrl="/study.jpg" description="NUS Modules" onClick={closeDrawer}/>
                    <DrawerBody>
                        <Content />
                    </DrawerBody>
                </DrawerContent>
