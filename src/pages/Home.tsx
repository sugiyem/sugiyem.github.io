...
const Home: React.FC = () => {
    ...
    const HeaderButtons: React.FC = () => (
        <Stack>
            <Button onClick={() => goToSelectedRef(educationRef)}>
                Education
            </Button>
            <Button onClick={() => goToSelectedRef(experienceRef)}>
                Experiences
            </Button>
            <Button onClick={() => goToSelectedRef(projectRef)}>
                Projects
            </Button>
            <Button onClick={() => goToSelectedRef(skillRef)}>
                Skills
            </Button>
            <Button onClick={() => goToSelectedRef(achievementRef)}>
                Achievements
            </Button>
            <Button onClick={() => goToSelectedRef(contactRef)}>
                Contact
            </Button>
        </Stack>
    )
    ...
    const CustomDrawer: React.FC = () => (
        <Drawer isOpen={isDrawerOpen} placement="right" onClose={closeDrawer}>
            <DrawerOverlay>
                <DrawerContent>
                    <CustomDrawerHeader imageUrl="/personal.jpg" description="Farrel Salim" onClick={closeDrawer}/>
                    <DrawerBody>
                        <HeaderButtons />
                    </DrawerBody>
                </DrawerContent>
